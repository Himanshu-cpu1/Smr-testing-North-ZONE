...
public class Andaman_Nicobar {
	 ...
	 public static WebDriver driver;
	    ...
	    public void filterSelection() throws InterruptedException {
	        ...
	        selectOption("(//*[@role=\"combobox\"])[2]", "(//*[text()=\"Andaman & Nicobar Island(8)\"])[2]");
	        Thread.sleep(4000);
	        selectOption("(//*[@role=\"combobox\"])[3]", "(//*[text()=\"All Vahan4 Running Office(3/3)\"])[3]");	        	        	        
