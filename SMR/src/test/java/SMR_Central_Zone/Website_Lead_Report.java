...
public class Website_Lead_Report {
	...
	public void Zone_Region_Wise() throws InterruptedException {
		...
		try {
			Lead_Generated = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
		...
		WebElement Lead_attempted = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
		WebElement Total_connected = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
		WebElement followup = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
		...
		WebElement Total_reported = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
		WebElement Total_Reported_PERCENT = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
		WebElement Reported_At_OWN = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[10]"));
		WebElement Reported_At_Other = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[11]"));
		WebElement Not_Connected = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[12]"));
		WebElement Not_Attempted = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[13]"));
