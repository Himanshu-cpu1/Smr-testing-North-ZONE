...
public class SMR_BOT_Status_Central {
	...
	//.........................................................................................................			
				...
				public void Zone_Region_Wise() throws InterruptedException {
				    ...
				    try {
				        Totalleads_recived = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
				    ...
				    WebElement total_Booking =      driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
				    WebElement total_reported =     driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
				    WebElement totallead =          driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
				    WebElement fresh =              driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[6]"));
				    WebElement pending =            driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[7]"));
				    WebElement followUP =           driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
				    WebElement appointment_Booked = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
				    WebElement reported =           driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[10]"));
				    WebElement reported_at_Own =    driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[11]"));
				    WebElement reported_at_Other =  driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[12]"));
				    WebElement lost =               driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[13]"));
				    WebElement totalLeads =         driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[14]"));
				    WebElement fresh2 =             driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[15]"));
				    WebElement pending2 =           driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[16]"));
				    WebElement follow_UP2 =         driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[17]"));
				    WebElement appointment_Booked2 =driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[18]"));
				    WebElement reported2 =          driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[19]"));
				    WebElement losreported_at_Own2 =driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[20]"));
				    WebElement reported_at_Other2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[21]"));
				    WebElement lost2 =              driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[22]"));
