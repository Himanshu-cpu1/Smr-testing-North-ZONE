...
public void Click_On_Report() throws InterruptedException {
	...
	public void Zone_Region_Wise() throws InterruptedException {
	    ...
	    try {
	        Total_Lead_Recived = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
	    ...
	    WebElement Actual_Earning = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
	    WebElement Total_Reported = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
	    WebElement Total_Booking = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
	    WebElement Fresh = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[6]"));
	    WebElement Pending_Fresh = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[7]"));
	    WebElement Follow_up_and_Pending_FollowUp = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
	    WebElement Refused = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
