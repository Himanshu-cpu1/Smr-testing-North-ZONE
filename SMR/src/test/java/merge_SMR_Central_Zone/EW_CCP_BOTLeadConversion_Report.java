...
//..................................................................................................
	...
	public void Click_On_EW_CCP_BOTLeadConversion_REPORT() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement EWCCP = wait.until(
				ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=\"EW-CCP Bot Lead Conversion \"]")));
		EWCCP.click();
		Thread.sleep(7000);
...
//..................................Zone And Region Wise Tab......................................................................................
	...
	public void Zone_And_Region_Wise_Tab() throws InterruptedException {
		...
		// Click on campaign report  and select all
				WebElement Campign = wait
				...
				WebElement ALL = wait
						.until(ExpectedConditions.presenceOfElementLocated(By.id("mat-option-0")));
				ALL.click();
		...
		WebElement TotalLeadsRecieved = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[2]"));
		WebElement NotAttemptedLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[3]"));
		WebElement NotConnectedLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[4]"));
		WebElement ConnectedFollowUpLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[5]"));
		WebElement ProposalSharedLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[6]"));
		WebElement ReadyToPurchaseLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[7]"));
		WebElement PurchaseCompletedLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[8]"));
		WebElement PurchaseCancelledLeads = driver
				.findElement(By.xpath("//tr[td[contains(normalize-space(), 'CENTRAL')]]/td[9]"));
		...
		if (z1==null) {
			System.out.println("No   data found for Zone and region wise of EW CCp boot_lead conversion"+z1);
		}
		...
		try {
			...
			if ( z1 == null) {
				...
				System.out.println("No Data Found for Zone And Region Wise In EW-CCP-lead conversion_Report ");
				...
				System.out.println(
						"'Total Leads Recieved' column Value of Zone And Region Wise Tab In EW-CCP-lead conversion_Report::: "
								+ z1);
			}
			...
			Assert.fail(
					"No Data Found for Zone And Region Wise Tab In EW-CCP-lead conversion_Report " + e.getMessage());
		}
	}
...
//.................................Dealer Parent Group Wise tab.....................................................................................		    
	...
	public void Dealer_Parent_Group_Wise_Tab() throws InterruptedException {
		...
		try {
			...
			if (TotalLeadRecieved == 0 ) {
				// Fail the test if 'Total Leads Recieved' column Value is 0 or less
				Assert.fail("No Data Found for Dealer Parent Group Wise In EW-CCP-lead conversion_Report : " + d1);
			} else {
				// Print the 'Total Leads Recieved' value
			//	System.out.println(
			//			"'Total Leads Recieved' column Value of Dealer Parent Group Wise Tab In EW-CCP-lead conversion_Report::: "
				//				+ d1);
			}

		} catch (Exception e) {
			// Fail the test if an exception is thrown
			Assert.fail("No Data Found for Dealer Parent Group Wise Tab In EW-CCP-lead conversion_Report "
					+ e.getMessage());
		}
	}
...
//.................................Workshop Wise Tab.....................................................................................		    
	...
	public void Workshop_Wise_Tab() throws InterruptedException {
		...
		System.out.println("Total Leads Recieved' column Value of Workshop Wise Tab In EW-CCP-lead conversion_Report::: "+w1);
		...
		try {
			...
			if (TotalLeadRecieved <= 0 || w1 == null) {
				...
				// Print the 'Total Leads Recieved' value
//				System.out.println(
//						"'Total Leads Recieved' column Value of Workshop Wise Tab EW-CCP-lead conversion_Report::: "
//								+ w1);
			}
	...
	public void Day_Wise_Tab() throws InterruptedException {
		...
		try {
			...
			if (TotalLeadRecieved <= 0 || day1 == null) {
				...
				// Print the 'Total Leads Recieved' value
//				System.out.println(
//						"'Total Leads Recieved' column Value of Day Wise Tab  In EW-CCP-lead conversion_Report::: "
//								+ day1);
			}
...
//...................................................................................................	
	@Test(priority = 15)
	public void Compare_ConnectedFollowUpLeads_Column_ZoneRegionWise_With_DealerParentWise()
...
//...................................................................................................	
	@Test(priority = 18)
	public void Compare_PurchaseCompletedLeads_Column_ZoneRegionWise_With_DealerParentWise()
			throws InterruptedException {
		Thread.sleep(1000);
...
//...................................................................................................	
	@Test(priority = 19)
	public void Compare_PurchaseCancelledLeads_Column_ZoneRegionWise_With_DealerParentWise()
			throws InterruptedException {
