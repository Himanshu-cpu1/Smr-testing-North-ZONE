...
//.................................Navigate To Auto Dialer Report.................................................................
	...
	public void Click_On_AutoDialer_REPORT() throws InterruptedException {
		wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		WebElement AutoDialer = wait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=\"Auto Dialer Report \"]")));
		AutoDialer.click();
		Thread.sleep(7000);
...
//............................To Validate if data is present in Zone And Region Wise tab..............................................................................................	   
	...
	public void Data_Verification_Zone_And_Region_Wise() throws InterruptedException {
		...
		if (reportRows.size() > 1) {
			System.out.println("Zone And Region Wise report contains data In Auto Dialer Report."); // Message when data
																									// is present
		}

		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The Zone and Region Wise report does not contain any data In Auto Dialer Report..");

		// Additional validation: Check if a specific element is not equal to zero
		WebElement specificElement = driver
		...
		Assert.assertNotEquals(elementText, "0",
				"The specific element is equal to zero, failing the test In Auto Dialer Report..");
	}
//...................................................................................  
...
//...........................To Validate Data is available for Dealer Parent Group Wise tab..................................................................................................	   
	...
	public void Data_Verification_Dealer_Parent_Group_Wise_Tab() throws InterruptedException {
		...
		// Check if the report contains data
		if (reportRows.size() > 1) {
			System.out.println("Dealer Parent Group Wise report contains data In Auto Dialer Report.."); // Message when
																											// data is
																											// present
		}
		...
		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The Dealer Parent Group Wise report does not contain any data  In Auto Dialer Report..");
	}
...
//..........................To Validate Data is available for Workshop Wise tab.............................................................................................	   
	...
	public void Data_Verification_Workshop_Wise_Tab() throws InterruptedException {
		...
		// Check if the report contains data
		if (reportRows.size() > 1) {
			System.out.println("Workshop Wise report contains data In Auto Dialer Report.."); // Message when data is
																								// present
		}

		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The Workshop Wise report does not contain any data In Auto Dialer Report.In Auto Dialer Report..");
	}
...
//..........................To Validate if data is available for Day Wise tab..................................................................................................	   
	...
	public void Data_Verification_Day_Wise_Tab() throws InterruptedException {
		...
		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The Day Wise report does not contain any data In Auto Dialer Report..");
	}
//.................................Navigate to SMRE Wise tab and select date range............................................  
	...
	public void SMRE_Wise_Tab() throws InterruptedException {
		...
		WebElement SMRE_Wise = wait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=\" SMRE Wise \"]")));
		SMRE_Wise.click();
		Thread.sleep(3000);
...
//............................To Validate data is available for SMRE Wise tab................................................................................................	   
	...
	public void Data_Verification_SMRE_Wise_Tab() throws InterruptedException {
		...
		// Check if the report contains data
		if (reportRows.size() > 1) {
			System.out.println("SMRE Wise report contains data In Auto Dialer Report.."); // Message when data is
																							// present
		}

		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The SMRE Wise report does not contain any data In Auto Dialer Report..");
	}
//.................................Navigate to Dump Wise Tab and select all parameters..................................................  
	...
	public void Dump_Wise_Tab() throws InterruptedException {
		...
		WebElement Dump_Wise = wait
				.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[text()=\" Dump Wise \"]")));
		Dump_Wise.click();
		Thread.sleep(3000);
...
//......................To Validate Data is available in Dump Wise tab..................................................................................................	   
	...
	public void Data_Verification_Dump_Wise_Tab() throws InterruptedException {
		...
		// Check if the report contains data
		if (reportRows.size() > 1) {
			System.out.println("Dump Wise report contains data In Auto Dialer Report.."); // Message when data is
																							// present
		}

		// Assert to fail the method if data is not present
		Assert.assertTrue(reportRows.size() > 1,
				"The Dump Wise report does not contain any data In Auto Dialer Report..");
	}
