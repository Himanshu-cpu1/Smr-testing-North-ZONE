...
public void Click_On_Report() throws InterruptedException {
	...
	public void Zone_Region_Wise() throws InterruptedException {
		...
		try {
			Total_Dispostion = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
		...
		WebElement Total_Interest_Dispostion = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
		WebElement Not_Interest_Dispostion = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
		WebElement Not_confiremed_Dispostion = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
		WebElement Total_Intrested = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[6]"));
		WebElement Yes = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[7]"));
		WebElement Gold = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
		WebElement Platinum = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
		WebElement Royal_Platinium = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[10]"));
		WebElement Total_Intrested1 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[11]"));
		WebElement Yes2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[12]"));
		WebElement CCP_Hydro = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[13]"));
		WebElement CCP_Fuel = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[14]"));
		WebElement CCP_Plus = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[15]"));

		WebElement Total_Intrested2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[16]"));
		WebElement yes2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[17]"));
		WebElement Platinum2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[18]"));
		WebElement Royal_Platinium2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[19]"));
		WebElement Total_Intrested3 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[20]"));
		WebElement Yes3 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[21]"));
		WebElement CCP_Hydro2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[22]"));
		WebElement CCP_Fuel2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[23]"));
		WebElement CCP_Plus2 = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[24]"));
