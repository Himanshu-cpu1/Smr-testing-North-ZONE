...
static void IC_Calculations(WebDriver driver) throws InterruptedException  {
	    ...
	    {
	 	   System.out.println("lnterest Cost page is displayed successfully with expected url: " +actICURL);
	    }    
	    else
	    {
	 	   System.out.println("Incorrect URL! lnterest Cost page will not display: " +actICURL);
	  ...
	  //calculation of elements as per requirement	    
	   ...
	   //calculation of elements as per requirement	    
		...
		double Q1= Double.parseDouble(QN1.getAttribute("value"));
		 ...
		 //get the value from automated cell
		 double result41= Long.parseLong(i49.getAttribute("value"));
		...
		//calculate LT longerest Cost Per Car
		 ...
		 //get the value from automated cell
		 double result42= Long.parseLong(i98.getAttribute("value"));
