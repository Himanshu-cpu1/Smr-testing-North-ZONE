...
static void MIR_Page(WebDriver driver) throws InterruptedException  {
		...
		WebElement mi13= driver.findElement(By.xpath("(//*[@type=\"number\"])[6]"));					
		...
		if(act1==roundedexp1) 
		  {
			 System.out.println("Insurance Renewal*- Per New Car Income/ Net- PASS=  " +roundedexp1);  
		  }
		else
		  {
			 System.out.println("Insurance Renewal*- Per New Car Income/Net- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>FAIL= " +roundedexp1);		   
		  }
		...
		if(act2==roundedexp2) 
		  {
			 System.out.println("Insurance Renewal Commission#- Per New Car Income/Net- PASS=  " +roundedexp2);  
		  }
		else
		  {
			 System.out.println("Insurance Renewal Commission#- Per New Car Income/Net- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>FAIL= " +roundedexp2);		   
		  }
		...
		if(act3==roundedexp3) 
		  {
			 System.out.println("Any other Income- Per New Car Income/Net- PASS=  " +roundedexp3);  
		  }
	    else
		  {
			 System.out.println("Any other Income- Per New Car Income /Net- >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>FAIL= " +roundedexp3);		   
		  }
		...
		if(act4==exp4) 
		   {
			 System.out.println("Total MI Renewal Income [A] ....... PASS=  " +exp4);  
		   }
		else
		   {
			   System.out.println("Total MI Renewal Income [A] >>>>>>>->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>. FAIL= " +exp4);
		   }
		...
		if(act5==roundedexp5) 
		  {
			 System.out.println("Per new Car income of [A] /Net PASS=  " +roundedexp5);  
		  }
		else
		  {
		     System.out.println("Per new Car income of [A] /Net >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>FAIL= " +roundedexp5);		   
		  }
		...
		if(act6==roundedexp6) 
		 ...
		 double mir11= Long.parseLong(mi11.getAttribute("value"));
		 // Get the attribute value from the second module's web element     
		 ...
		 if(ic11.equals(icmir)) 
		  ...
		  if(act7==roundedexp7) 
			...
			double mirq13= Long.parseLong(miq13.getAttribute("value"));
			//calculate per new car expense of Manpower Cost- auto populated cell
