...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	//.>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
	  		// Then We put the condition for All AutoPopulated 	& calculations shells 
	              ...
	              if (TRUE1 == expectedValues ) {
			        	
					  System.out.println("AUTOPOPULATED  POC Sales[Quantity (A+B-C)] VALID  =" + TRUE1 );
												                            
				       } else {
			 	System.out.println("AUTOPOPULATED  POC Sales[Quantity (A+B-C)] >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>INVALID  = " + TRUE1 );			        
						 }	
//........................................................................................................
