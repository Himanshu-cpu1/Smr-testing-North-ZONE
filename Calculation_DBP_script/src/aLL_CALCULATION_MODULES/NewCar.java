	...
	static void NewCar_Page(WebDriver driver) throws InterruptedException {
		...
		//click on New Car 
				...
				if(actresult2==roundexp2) 
				  {
					System.out.println("Total DRF Amount: Per new car income formula cell displays correct value- PASS=  " +actresult2);  
				  }
				else
				  {
					 System.out.println("Total DRF Amount: Per new car income formula cell displays incorrect value->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> FAIL= " +actresult2);
				  }
		      ...
		      System.out.println("Short term IC- Auto populated cell in Interest Cost page: "+amount11);
