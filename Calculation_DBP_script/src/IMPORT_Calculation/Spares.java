...
//	    driver.findElement(By.xpath("(//*[@type=\"button\"])[3]")).click();
	   // System.out.println("Data is saved");
		...
		//navigate to lnterest Cost page
		Thread.sleep(3000);
		driver.findElement(By.xpath("(//*[@class=\"mat-line\"])[4]")).click();
		Thread.sleep(2000);
		WebElement ic1 = driver.findElement(By.xpath("(//*[@type=\"number\"])[44]")); //  Spares- longerest Cost page
		Thread.sleep(2000);
		String icst = ic1.getAttribute("value");    
		//System.out.println("longerest Cost Page- ST Spares auto populated cell: "+ icst);
	    ...
	    System.out.println("ST lnterest Cost for Spares- Auto populated cell in Spares: "+ spic1);
		...
		long roundedexp12 = Math.round(exp12);   //calculate per new car- Short term longerest Cost	    
		//Verify if result is as expected
		if(sp34==roundedexp12) 
		  {
			 System.out.println("Short term longerest Cost- Per new Car auto populated cell displays correct value- PASS=  " +roundedexp12);  
		  }
		else
		  {
			 System.out.println("Short term longerest Cost- Per new Car auto populated cell displays incorrect value->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> FAIL= " +roundedexp12);		   
		  }
		//.......................................................................................................................................
