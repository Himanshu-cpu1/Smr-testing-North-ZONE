...
//			C:\Users\Thinkpad\Downloads\DBP 3.0 Nexa Ganesh cars dummy data.xlsx
...
//	....................//.Stock all models..................................
//................................................................................	
					    Click_on_The_STOCKS.click(driver);
				        ALTO_k10.stock(driver);
					   	SPresso.spresso(driver);
					    Celerio.CElERIO(driver);
					    WAGONR_R.wagonr(driver);
					    SWIFT.swift(driver);
					    DZIRE.dzire(driver);
					    BREZZA.Brezza(driver);
					    ERTIGA.ertiga(driver);
					    ECO.eco(driver);
		     		    SUPPER_CARRY.supercarry(driver);
					    Totals.total(driver);
	//////////////////////////////////////////////////////////////////////////////////////////////			
					Thread.sleep(2000);   
					Discount.discount(driver);
					InterestCost.IC_Calculations(driver);                                                  // n
					...
					Autopopulate_SubmitDBP.Submit_DBP_Page(driver);
