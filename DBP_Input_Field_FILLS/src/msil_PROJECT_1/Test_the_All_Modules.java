...
public class Test_the_All_Modules {
	...
	//////////////////////////////////////////////////////////////////////////////////////////
			...
			/*	Network_Details.networkdetails(driver);
				Stock_Sheet.stocksheet(driver);
				Discount.discount(driver);
				Intrest_cost.Intrestcost(driver);
				Man_power_count.manpowercount(driver);
				Manpower_cost.manpowercost(driver);
				New_car.newcars(driver);
				MDS.mds(driver);
				Maruti_Insurance.marutiInsurance(driver);
			    MSGA.msga(driver);
				True_value.truevalue(driver);
				Spares.spares(driver);
				Services.service(driver); */
				Comman_expenses.commanexpenses(driver);
				//Key_financials.keyfinancials(driver);
