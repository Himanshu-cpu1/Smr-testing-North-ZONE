...
//........................................................................................................................
	...
	public void Zone_And_Region_Wise_Tab() throws InterruptedException {
		...
		WebElement TotalCampaignLeads = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
		WebElement LeadsAttempted = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
		WebElement FollowUp = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
		WebElement Connected = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
		WebElement AppointmentBooked = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[6]"));
		WebElement PercentAppointmentBooked = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[7]"));
		WebElement Reported = driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
		WebElement PercentReported = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
		WebElement ReportedForFreeService = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[10]"));
		WebElement PercentReportedForFreeService = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[11]"));
		WebElement ReportedForPaidService = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[12]"));
		WebElement PercentReportedForPaidService = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[13]"));
		WebElement FreeServicePaidServiceReported = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[14]"));
		WebElement PercentFreeServicePaidServiceReported = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[15]"));
		WebElement NotAttempted = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[16]"));
		WebElement NotConnected = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[17]"));
		WebElement LabourRevenue = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[18]"));
		WebElement PartsRevenue = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[19]"));
		WebElement LabourPartsRevenue = driver
				.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[20]"));
