...
//........................................................................................................................
		    ...
		    public void Zone_And_Region_Wise_Tab() throws InterruptedException {
		     ...
		     // Select start date (1st of the current month)
		        ...
		        WebElement TotalInterestedLeads=   driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[2]"));
		    	WebElement NotAttemptedLeads=      driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[3]"));
		    	WebElement NotConnectedLeads=      driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[4]"));
		    	WebElement ConnectedFollowUpLeads= driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[5]"));
		    	WebElement ProposalSharedLeads=    driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[6]"));
		    	WebElement ReadyToPurchaseLeads=   driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[7]"));
		    	WebElement PurchaseCompletedLeads= driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[8]"));
		    	WebElement PurchaseCancelledLeads= driver.findElement(By.xpath("(//tr[td[contains(text(),'CENTRAL')]])[1]/td[9]"));
