	      ...
	      //Elements of Zone and Region Wise
	    	...
	    	try {
	            ...
	            if (TotalLeadRecieved <= 0 || z1==null) {
	                ...
	                System.out.println("'Total Leads Recieved' column Value of Zone And Region Wise Tab is::: " + z1);
	            }
	     ...
	     // Select start date (1st of the current month)
	    	...
	    	try {
	            ...
	            if (TotalLeadRecieved <= 0 || d1==null) {
	                ...
	                // Print the 'Total Leads Recieved' value
	                System.out.println("'Total Leads Recieved' column Value of Dealer Parent Group Wise Tab is::: " + d1);
	            }
	     ...
	     // Select start date (1st of the current month)
	    	...
	    	try {
	            ...
	            if (TotalLeadRecieved <= 0 || w1==null) {
	                ...
	                // Print the 'Total Leads Recieved' value
	                System.out.println("'Total Leads Recieved' column Value of Workshop Wise Tab is::: " + w1);
	            }
		   ...
		   Thread.sleep(7000);
	    	...
	    	try {
	            ...
	            if (TotalLeadRecieved <= 0 || day1==null) {
	                ...
	                // Print the 'Total Leads Recieved' value
	                System.out.println("'Total Leads Recieved' column Value of Day Wise Tab is::: " + day1);
	            }
