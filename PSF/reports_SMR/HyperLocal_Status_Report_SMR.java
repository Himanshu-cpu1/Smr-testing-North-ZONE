			      ...
			      //Elements of Zone and Region Wise
			    	...
			    	try {
			            ...
			            if (LeadGeneratedValue <= 0 || z1==null) {
			                ...
			                System.out.println("'Lead Generated' column Value of Zone And Region Wise Tab is::: " + z1);
			            }
				 ...
				 // Select start date (1st of the current month)
			        ...
			        try {
			            ...
			            if (Lead_Generated <= 0 || d1==null) {
			                ...
			                System.out.println("'Lead Generated' column value of Dealer Parent Group Wise Tab is::: " + d1);
			            }
			    ...
			    public void WorkShop_Wise_Tab() throws InterruptedException {
			        ...
			        try {
			            ...
			            if (Lead_Generated <= 0 || w1==null) {
			                ...
			                // Print the Lead Generated value
			                System.out.println("'Lead Generated' column value of WorkShop Wise Tab is::: " + w1);
			            }
			     ...
			     // Select start date (1st of the current month)
			        ...
			        try {
			            ...
			            if (Lead_Generated <= 0 || day1==null) {
			                ...
			                // Print the Lead Generated value
			                System.out.println("'Lead Generated' column value of Day Wise Tab is ::: " + day1);
			            }
