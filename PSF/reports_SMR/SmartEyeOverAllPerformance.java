		      ...
		      //Elements of Zone and Region Wise
		    	...
		    	try {
		            ...
		            if (TotalJCOpen <= 0 || z1==null) {
		                ...
		                System.out.println("'Total JC Open' column Value of Zone And Region Wise Tab is::: " + z1);
		             }
		    ...
		    public void Dealer_Parent_Group_Wise_Tab() throws InterruptedException {
		      ...
		      //Elements of Dealer Parent Group Wise
		    	...
		    	try {
		            ...
		            if (TotalJCOpen <= 0 || d1==null) {
		                // Fail the test if Total JC Open column Value is 0 or less
		                Assert.fail("No Data Found for Dealer Parent Group Wise: " + d1);
		            } else {
		                // Print the Total JC Open value
		                System.out.println("'Total JC Open' column Value of Dealer Parent Group Wise Tab is::: " + d1);
		             }
		    ...
		    public void Workshop_Wise_Tab() throws InterruptedException {
		      ...
		      //Elements of Workshop Wise
		    	...
		    	try {
		            ...
		            if (TotalJCOpen <= 0 || w1==null) {
		                // Fail the test if Total JC Open column Value is 0 or less
		                Assert.fail("No Data Found for Workshop Wise: " + w1);
		            } else {
		                // Print the Total JC Open value
		                System.out.println("'Total JC Open' column Value of Workshop Wise Tab is::: " + w1);
		             }
		    ...
		    public void Day_Wise_Tab() throws InterruptedException {
		      ...
		      //Elements of Day Wise
		    	...
		    	try {
		            ...
		            if (TotalJCOpen <= 0 || day1==null) {
		                // Fail the test if Total JC Open column Value is 0 or less
		                Assert.fail("No Data Found for Day Wise: " + day1);
		            } else {
		                // Print the Total JC Open value
		                System.out.println("'Total JC Open' column Value of Day Wise Tab is::: " + day1);
		             }
		    ...
		    public void Service_Type_Wise_Tab() throws InterruptedException {
		      ...
		      //Elements of Service Type Wise
		    	...
		    	try {
		            ...
		            if (TotalJCOpen <= 0 || s1==null) {
		                // Fail the test if Total JC Open column Value is 0 or less
		                Assert.fail("No Data Found for Service Type Wise: " + s1);
		            } else {
		                // Print the Total JC Open value
		                System.out.println("'Total JC Open' column Value of Service Type Wise Tab is::: " + s1);
		             }
...
//...............................Dump Wise Tab.......................................................................................		    
		   ...
		   @Test(priority = 12)
			public void Dump_Wise_Tab() throws InterruptedException, TimeoutException {
		     ...
		     // Calculate dates
		        LocalDate today = LocalDate.now();
		        LocalDate startDate = today.minusDays(3); // 2 days before yesterday
		        LocalDate endDate = today.minusDays(1);   // Yesterday
		        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd-MM-yyyy");

		        // Select start date (2 days before today)
		        WebElement selectStart = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[aria-label=\"" + startDate.format(formatter) + "\"]")));
		        selectStart.click();
		        Thread.sleep(2000);

		        // Select yesterday's date
		        WebElement selectYesterday = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("[aria-label=\"" + endDate.format(formatter) + "\"]")));
...
//			    // Click on the "Download" icon
               ...
               actions1.click(Download_Dump1).perform();
			    ...
			    Thread.sleep(6000);	 //dump is downloaded.		    			 			   
}
